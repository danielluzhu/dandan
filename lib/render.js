...
export function homePage({ upcoming, ideas, past, thanks, admin = false }) {
...
<footer class="foot">
  ...
  ${/* The way in to the signups. Both pages sit behind the password either way,
        so this only saves typing the URL — but once signed in it is worth
        naming the events page too. */""}
  <p class="foot__mine">
    <a class="btn btn--ghost btn--sm" href="/list">The List</a>
    ${admin ? `<a class="btn btn--ghost btn--sm" href="/admin">Events</a>` : ""}
  </p>
</footer>`;
