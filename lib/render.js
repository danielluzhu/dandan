  ...
  <section class="admin__panel" id="contacts">
    ...
    <ul class="contacts">
      ${signups.map((c) => {
        ...
        return `
      <li class="contact" data-categories="${esc(picked.join(","))}">
    ...
    <p class="contacts__empty" hidden>Nobody on the list has said they're up for that yet.</p>` : `<p class="empty">No contacts yet. People who fill in the form on the site land here, or add one by hand above.</p>`}
